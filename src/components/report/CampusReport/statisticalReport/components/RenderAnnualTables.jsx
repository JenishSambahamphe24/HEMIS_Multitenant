...
const AnnualSystemTables = ({ rows, title, index, fiscalYear }) => {
  ...
  return (
    <Box mb={2}>
      <p className="sub-heading">{`1.${index}`} <span className="ml-2">{title}</span></p>
      <TableContainer sx={{ border: "1px solid #ddd" }}>
        <Table size="small">
          <TableHead style={{ backgroundColor: "#2A629A", color: 'white' }}>
            ...
            <TableRow>
              <TableCell className="table-heading" rowSpan={2} align="center" sx={{ border: "1px solid black" }}>
                Year
              </TableCell>
              <TableCell className="table-heading" colSpan={4} align="center" sx={{ border: "1px solid black" }}>
                Gender
              </TableCell>
              <TableCell className="table-heading" rowSpan={2} align="center" sx={{ border: "1px solid black" }}>
                EDJ
              </TableCell>
              <TableCell className="table-heading" colSpan={9} align="center" sx={{ border: "1px solid black" }}>
                Ethnicity
              </TableCell>
            </TableRow>
            <TableRow>
          ...
          <TableBody>
            {rows.map((item, index) => (
              <TableRow key={index}>
                <TableCell align="left" sx={{ border: "1px solid black" }}>{item.year}</TableCell>
...
const RenderAnnualTables = ({ data, fiscalYear, index }) => {
...
export default RenderAnnualTables;
