...
const EmployeeAddressGeneralInfo = ({ handleNext, handleBack }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setSelectedProvince(employeeAddress?.pProvince);
        setSelectedDistrict(employeeAddress?.pDistrict);
        setSelectedProvince2(employeeAddress?.tProvince);
        setSelectedDistrict2(employeeAddress?.tDistrict);
        setSameAsPermanent(employeeAddress?.isSameAsPermament);
      } catch (err) {
        console.log(err);
      }
    };
            ...
            <Grid item xs={12} sm={4}>
              <FormControl size="small" fullWidth>
                ...
                <Controller
                  ...
                  defaultValue={
                    sameAsPermanent
                      ? employeeAddress.pProvince
                      : employeeAddress.tProvince
                  }
                  render={({ field }) => (
                    <ValidationSelect
                      {...field}
            ...
            <Grid item xs={12} sm={4}>
              <FormControl size="small" fullWidth>
                ...
                <Controller
                  ...
                  defaultValue={
                    sameAsPermanent
                      ? employeeAddress.pDistrict
                      : employeeAddress.tDistrict
                  }
                  render={({ field }) => (
                    <ValidationSelect
                      {...field}
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    ...
                    >
                      ...
                      {gettWardOptions(employeeAddress.tLocalLevel).map(
                        (ward) => (
                          <MenuItem key={ward} value={ward}>
                            {ward}
                          </MenuItem>
