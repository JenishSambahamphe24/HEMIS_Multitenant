...
import StudentAppearedList from "./StudentAppearedList";
import { getAuthConfigSafe } from "../../../utils/dateUtils";
import {config} from '@config';

const FilterAppearedStudent = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetchWithAuth(
        `${backendUrl}/BulkExamAttend/GetAllAppearedStudents?BatchId=${selectedBatchId}&ExamScheduleId=${selectedExamId}`
      );
      if (response) {
...
export default FilterAppearedStudent;
