...
import TransferStudent from "../TransferToStudent"; // Make sure this path is correct
import { getPaginatedVerifiedStudents } from "../../../components/dashboard/services/service";

const TransferOutFromSystem = () => {
  ...
  // Handle transfer request button click
  const handleTransferRequest = (studentId) => {
    ...
    <>
      {loading ? (
        ...
        <div style={{ textAlign: "center", marginTop: "20px" }}>
          <h1 className="text-md  text-left  mb-1">
            Find the student using the filter. You can request a transfer from
                    ...
                    {studentData && studentData.length > 0 ? (
                      studentData.map((data, index) => (
                        <TableRow key={data.id}>
                          ...
                          >
                            <Button
                              onClick={() => handleTransferRequest(data.id)}
                              disabled={loading}
                              size="small"
                            >
                              Transfer request
...
export default TransferOutFromSystem;
