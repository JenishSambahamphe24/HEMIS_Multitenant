...
const DiscountReport = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Filter to show only Discount data
      const scholarshipData = response.data?.scholarships?.filter(
        (item) =>
          item.scholarshipType === "Discount" ||
          item.scholarshipType === "discount" ||
          item.scholarshipType === "DISCOUNT"
      );
  ...
  const exportToExcel = () => {
    ...
    // Add title row
    const title = "List of Students with Discounts";
    ...
    XLSX.writeFile(workbook, "Students with Discounts.xlsx");
  };
        ...
        <div style={{ textAlign: "center", marginTop: "20px" }}>
          ...
          >
            ...
            <Grid item xs={12} sm={6} md={5.7}>
              ...
              >
                List of Students with Discounts{" "}
              </Typography>
            </Grid>
            <Grid
              item
